...
namespace WeatherBotV1.Services.OpenMeteo
{
    public class OpenMeteoServiceBase
    {
        ...
        {
            var uri = new UriBuilder(@$"https://archive-api.open-meteo.com/v1/archive?latitude=+{latitude.ToString().Replace(',', '.')}&longitude={longitude.ToString().Replace(',', '.')}&start_date=2000-01-01&end_date=2023-03-05&hourly=temperature_2m&daily=temperature_2m_max,temperature_2m_min&timezone=America%2FSao_Paulo");
